...
import id.ggdev.ggdevcommerce.shouldBypassOTPValidation
import id.ggdev.ggdevcommerce.ui.OTPStatus
...
class OtpViewModel(application: Application, private val uData: UserData) :
	...
	private fun verifyPhoneWithCode(verificationId: String, code: String, isUserLoggedIn: MutableLiveData<Boolean>) {
		try {
			...
			authRepository.signInWithPhoneAuthCredential(credential, isUserLoggedIn, getApplication<GgDevCommerceApplication>().applicationContext)
		} catch (e: Exception) {
