package id.ggdev.ggdevcommerce.viewModels
...
import id.ggdev.ggdevcommerce.ERR_EMAIL
import id.ggdev.ggdevcommerce.ERR_INIT
import id.ggdev.ggdevcommerce.ERR_MOBILE
import id.ggdev.ggdevcommerce.GgDevCommerceApplication
import id.ggdev.ggdevcommerce.data.UserData
import id.ggdev.ggdevcommerce.data.utils.LogInErrors
import id.ggdev.ggdevcommerce.data.utils.SignUpErrors
import id.ggdev.ggdevcommerce.data.utils.UserType
import id.ggdev.ggdevcommerce.getRandomString
import id.ggdev.ggdevcommerce.isEmailValid
import id.ggdev.ggdevcommerce.isPhoneValid
import id.ggdev.ggdevcommerce.ui.LoginViewErrors
import id.ggdev.ggdevcommerce.ui.SignUpViewErrors
...
class AuthViewModel(application: Application) : AndroidViewModel(application) {
	...
	private val authRepository = (application as GgDevCommerceApplication).authRepository
	private val productsRepository = (application as GgDevCommerceApplication).productsRepository
	...
	private fun checkUniqueUser(uData: UserData) {
		viewModelScope.launch {
			val res = async { authRepository.checkEmailAndMobile(uData.email, uData.mobile, getApplication<GgDevCommerceApplication>().applicationContext) }
